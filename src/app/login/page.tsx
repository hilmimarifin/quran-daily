    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-muted/20">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl">Assalamualaikum</CardTitle>
          <CardDescription>
            Silahkan masuk untuk dapat menyimpan dan melihat progres bacaan/hanca.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
        ...
        <CardFooter>
          <div className="text-xs text-center text-muted-foreground w-full">
            Bacalah Al-Quran setiap hari meski hanya 1 ayat.
          </div>
        </CardFooter>
      </Card>
    </div>
