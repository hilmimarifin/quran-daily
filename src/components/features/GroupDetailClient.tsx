          ...
          <CardContent className="p-3 flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-muted-foreground">
                {currentUserMember.bookmark.name} - S{currentUserMember.bookmark.surah_number}:V{currentUserMember.bookmark.verse_number}
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <Card className="border-none bg-card">
                <CardContent className="p-4 flex items-center gap-4">
                  ...
                  <Avatar>
                    ...
                    <AvatarFallback>{currentUserMember.profile?.display_name?.[0] || 'U'}</AvatarFallback>
                  </Avatar>
                  <div className="flex-1">
                    <div className="font-medium">
            ...
            {group.members.map((member) => (
              <div key={member.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-muted/50">
                ...
                <div className="flex-1 text-sm">
                  ...
                  <span className="ml-2 text-xs text-muted-foreground capitalize">({member.role})</span>
                </div>
                <div className="text-xs text-muted-foreground">
                   {member.bookmark 
